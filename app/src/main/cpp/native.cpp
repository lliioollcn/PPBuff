...
#include "helperlog.h"
#include <string>
#include "cn_lliiooll_ppbuff_ffmpeg_FFmpeg.h"
...
namespace {
    ...
    Java_cn_lliiooll_ppbuff_utils_Natives_test(JNIEnv *env, jclass thiz) {
        LOGI("[Native] >>> test <<<");
    }
    ...
    extern "C" JNIEXPORT void JNICALL Java_cn_lliiooll_ppbuff_ffmpeg_FFmpeg_initNative
    ...
    extern "C" JNIEXPORT void JNICALL Java_cn_lliiooll_ppbuff_ffmpeg_FFmpeg_runCmd
